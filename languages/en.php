...
return [
	...
	'related-items:limit-date' => 'Show only items created between now and a specific timing period?',
	'related-items:limit-date-help' => 'If the above answer is "Yes", Enter timing in the format: <i>negative number</i> followed by <i>time interval</i> i.e., day/week/month/year) (Example: -1 year) ',
